...
class EventDetector:
    ...
    def update_release(self, frame_idx: int, wrist) -> None:
        ...
        # Do not allow release before front-foot contact is established.
        ...
        # Preferred method: ball separates from wrist and continues away in the delivery phase.
        ...
        if ball is not None:
            ...
            wrist_in_release_zone = float(wrist.y) < 0.55
            if dist > self.RELEASE_DIST_THRESH and ball_moving and moving_away_from_wrist and wrist_in_release_zone:
        ...
        # Fallback: wrist is high and then begins descending after FFC.
